...
MONGODB_URL = "mongodb://127.0.0.1:27018/" # Replace 27018 with actual port number of database
MONGODB_DATABASE = "NY_Project"  # Replace with your actual database name
...
def get_average_word_count(current_user: str = Depends(get_current_user)):
    ...
    collection = mongo_db.ny_articles_aggregated_data # Replace with your actual collection name
